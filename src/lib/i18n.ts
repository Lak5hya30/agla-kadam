...
export const STRINGS: Dict = {
  ...
  "analysis.headAddressed": { en: "Your request appears to have been addressed.", hi: "आपका अनुरोध पूरा किया गया प्रतीत होता है।" },
  "analysis.headPartial": { en: "Marked disposed, but the response does not fully confirm the outcome.", hi: "निपटाई गई दिखती है, लेकिन जवाब पूरे नतीजे की पुष्टि नहीं करता।" },
